...
for i=1:length(timePoints)
  ...
  for d=1:size(C,1)
      ...
      %%
      matAdjRSquare=zeros(1,length(fitMethods));
      ...
      str=fullfile('Outs','binning_plot_2brainDiv','gene_coexpress',strcat('GeneCoexpress_',timePoints{i},brainDivision{combNow1},brainDivision{combNow2},'_random1000_annoOnly_30%filter_noSC_massiveVer.jpg'));
      ...
      saveas(f,str)
      str=fullfile('Outs','binning_plot_2brainDiv','R-square_exp_voxel',strcat('R-square_exp_voxel_',timePoints{i},brainDivision{combNow1},brainDivision{combNow2},'_random1000_annoOnly_30%filter_noSC_massiveVer.jpg'));
      ...
      saveas(g,str)
      str=fullfile('Outs', 'binning_plot_2brainDiv','expoFit_voxel',strcat('expoFit_voxel_',timePoints{i},brainDivision{combNow1},brainDivision{combNow2},'_random1000_annoOnly_30%filter_noSC_massiveVer.jpg'));
      ...
      str=fullfile('Matlab_variables',strcat('makeGridData1_2BrainDiv',timePoints{i},brainDivision{combNow1},brainDivision{combNow2},'.mat'));
