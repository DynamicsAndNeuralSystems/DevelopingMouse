...
geneSubsets = {'neuron', 'astrocyte'}; %'allCellTypes',, 'oligodendrocyte'};
numGeneSubsets = length(geneSubsets);
...
%-------------------------------------------------------------------------------
for g = 1:numGeneSubsets
    params.thisCellType = geneSubsets{g};
    for b = 1:numBrainDivs
        params.thisBrainDiv = brainDivs{b};
        fprintf(1,'\n===[[%u/%u]] %s: %s\n\n',b,numBrainDivs,...
                        params.thisCellType,params.thisBrainDiv);
