...
filestr='spatialData_NumData_1000_subsetGenes';
...
str=fullfile('Matlab_variables',strcat('fitting_NumData_',NumData,'_subsetGenes','.mat'));
...
str=fullfile('Matlab_variables',strcat('fitting_NumData_',NumData,'_subsetGenes_scaled','.mat'));
