...
for i=1:length(dataType)
    ...
    maxDistance.(dataType{i})]=getFitting(dataType{i},...
                                spatialData.(dataType{i}).distancesAll_scaled,...
                                spatialData.(dataType{i}).corrCoeffAll,...
                                'wholeBrain',...
                                'original');
    % save figure
    str=fullfile('Outs', 'decay_constant_scaled',strcat('decayConstant_scaled',dataType{i},'.jpeg'));
...
% save variables
%----------------------------------------------------------------------------------------------
str=fullfile('Matlab_variables','fitting_scaled.mat');
