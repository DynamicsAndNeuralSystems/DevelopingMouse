...
% as there are no bad bins in enriched gene data, the removeBadBin flag is used
  ...
  if strcmp(thisBrainDiv,'wholeBrain')
    ...
    if scaledDistance
      if ((strcmp(thisBrainDiv,'midbrain')|strcmp(thisBrainDiv,'hindbrain')) & removeBadBin)
        str=fullfile('Outs',strcat('binning_plot_withExponential','_',...
                                  thisBrainDiv,'_',thisCellType,'_removeBadBin_scaled'),...
                            strcat('voxel_binning_withExponential','_',...
                                  thisBrainDiv,'_',thisCellType,'_removeBadBin_scaled_',...
                                  timePoints{i},'.jpeg'));
      else
      ...
      if ((strcmp(thisBrainDiv,'midbrain')|strcmp(thisBrainDiv,'hindbrain')) & removeBadBin)
        str=fullfile('Outs',strcat('binning_plot_withExponential','_',thisBrainDiv,...
                                  '_',thisCellType,'_removeBadBin'),...
                            strcat('voxel_binning_withExponential','_',thisBrainDiv,...
                                  '_',thisCellType,'_removeBadBin_',timePoints{i},'.jpeg'));
      else
