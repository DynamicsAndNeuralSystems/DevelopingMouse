...
for i=1:length(dataType)
    [f, fitting_stat_all.(dataType{i}), decayConstant.(dataType{i}), maxDistance.(dataType{i})]=getFitting(dataType{i},spatialData.(dataType{i}).distancesAll,spatialData.(dataType{i}).corrCoeffAll);
    % save figure
