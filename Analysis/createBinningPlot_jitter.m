...
for i=1%:length(timePoints)
  ...
  [~,F]=BF_PlotQuantiles_diffColor_Jitter(distances_all{i},corrCoeff_all{i},binnedDataCell_all{i},...
                                    cmapOut,timePoints{i});
  str=fullfile('Outs','binning_plot_with_jitter',strcat('binning_plot_with_jitter_',timePoints{i},'.jpeg'));
