function [f] = plotStructures_scatter(xData, yData, dotColorCell, labelingCell, divisionLabel, numData, plotTitle)
  ...
  for i = 1:numData
      text(xData(i)+0.04*xDataRange,yData(i),labelingCell{i},...
