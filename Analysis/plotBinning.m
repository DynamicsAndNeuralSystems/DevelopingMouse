function [f,F,xPlotDataAll,yPlotDataAll] = plotBinning(xData_all,yData_all,numThresholds,makePlot)
  ...
  % makePlot: a flag for whether to create the plot; true or false
  ...
  for i=1:length(timePoints)
      ...
      if makePlot
          theColor=cmapOut(i,:);
          plot(xPlotDataAll{i},yPlotDataAll{i},'-o','MarkerSize',5,'LineStyle',theStyle,...
