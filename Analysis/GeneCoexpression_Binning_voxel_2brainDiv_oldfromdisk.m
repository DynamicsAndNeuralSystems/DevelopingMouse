...
for i=1%:7
    for d=1:size(C,1)
        combNow1=C(d,1);
        combNow2=C(d,2);
        fileStr=strcat('makeGridData1_2BrainDiv',timePoints{i},brainDivision{combNow1},brainDivision{combNow2},'.mat');
        divStr=strcat(brainDivision{combNow1},'_',brainDivision{combNow2});
...
for i=1%:7
    ...
    for d=1:size(C,1)
        ...
        t=text(0.5,0.5,char(strcat(brainDivision{combNow1},'-',brainDivision{combNow2})),'color','k','FontSize',14,'BackgroundColor',...
                cmapOut(d,:));
        t.Units='normalized';
    ...
    str=fullfile('Outs','exponential_plot_2brainDiv',strcat('exponential_plot_2brainDiv_',timePoints{i},'.jpg'));
    saveas(w,str)
end
...
for i=1%:7
    ...
    title(str,'Fontsize',19);
    w=figureFullScreen(w,true);
    str=fullfile('Outs','binning_threshold_2brainDiv','continuous',...
                  strcat('binning_threshold_2brainDiv',...
                  numThresholds,'_',timePoints{i},'_continuous','.jpg'))
    % str=strcat('DevelopingMouse_Binning_Threshold_',numThresholds,'_',timePoints{i},'_continuous','.jpg');
    saveas(w,str)
end
%%
...
for i=1%:7
    ...
    str=fullfile('Outs','binning_threshold_2brainDiv','dotted',...
                  strcat('binning_threshold_2brainDiv',numThresholds,'_',...
                  timePoints{i},'_dotted','.jpg'));
    saveas(u,str)
end
