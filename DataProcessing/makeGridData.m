function [voxGeneMat, distMat] = makeGridData(whatTimePointNow, whatNumData, whatNorm)% for whatNorm: must leave it as empty string ' ' if 'scaledSigmoid'; options:' ', 'zscore','log2';
